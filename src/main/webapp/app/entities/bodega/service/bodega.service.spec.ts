...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../bodega.test-samples';

import { BodegaService } from './bodega.service';

const requireRestSample: IBodega = {
...
describe('Bodega Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Bodega', () => {
      const bodega = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(bodega).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Bodega', () => {
      const bodega = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(bodega).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addBodegaToCollectionIfMissing', () => {
      it('should add a Bodega to an empty array', () => {
        const bodega: IBodega = sampleWithRequiredData;
      ...
      it("should add a Bodega to an array that doesn't contain it", () => {
        const bodega: IBodega = sampleWithRequiredData;
        const bodegaCollection: IBodega[] = [sampleWithPartialData];
        expectedResult = service.addBodegaToCollectionIfMissing(bodegaCollection, bodega);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(bodega);
      });
      ...
      it('should add only unique Bodega to an array', () => {
        const bodegaArray: IBodega[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const bodegaCollection: IBodega[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const bodega: IBodega = sampleWithRequiredData;
        const bodega2: IBodega = sampleWithPartialData;
    ...
    describe('compareBodega', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareBodega(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareBodega(entity1, entity2);
        const compareResult2 = service.compareBodega(entity2, entity1);
