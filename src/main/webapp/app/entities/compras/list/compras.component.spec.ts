...
import { sampleWithRequiredData } from '../compras.test-samples';
...
describe('Compras Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to comprasService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getComprasIdentifier');
      const id = comp.trackId(entity);
      expect(service.getComprasIdentifier).toHaveBeenCalledWith(entity);
