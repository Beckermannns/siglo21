...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../compras.test-samples';

import { ComprasService } from './compras.service';

const requireRestSample: ICompras = {
...
describe('Compras Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Compras', () => {
      const compras = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(compras).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Compras', () => {
      const compras = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(compras).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addComprasToCollectionIfMissing', () => {
      it('should add a Compras to an empty array', () => {
        const compras: ICompras = sampleWithRequiredData;
      ...
      it("should add a Compras to an array that doesn't contain it", () => {
        const compras: ICompras = sampleWithRequiredData;
        const comprasCollection: ICompras[] = [sampleWithPartialData];
        expectedResult = service.addComprasToCollectionIfMissing(comprasCollection, compras);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(compras);
      });
      ...
      it('should add only unique Compras to an array', () => {
        const comprasArray: ICompras[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const comprasCollection: ICompras[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const compras: ICompras = sampleWithRequiredData;
        const compras2: ICompras = sampleWithPartialData;
    ...
    describe('compareCompras', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareCompras(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareCompras(entity1, entity2);
        const compareResult2 = service.compareCompras(entity2, entity1);
